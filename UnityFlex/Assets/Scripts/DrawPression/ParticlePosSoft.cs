...
public class ParticlePosSoft : MonoBehaviour
{
    ...
    private FlexSoftActor fsaFlexSourceActor;
    private int i = 0;
    ...
    ParticlePosSoft(FlexContainer container, FlexSoftActor flexsoftactor, Gradient gradient, float timer, int beforelastparticle)
    {
        fcContainer = container;
        fsaFlexSourceActor = flexsoftactor;
    ...
    public void SetValues(FlexContainer container, FlexSoftActor flexsoftactor, Gradient gradient, float timer, int beforelastparticle)
    {
        fcContainer = container;
        fsaFlexSourceActor = flexsoftactor;
        GGradientColor = gradient;
